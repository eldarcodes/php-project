...
<div class="container">
    <div class="d-flex">
        <div style="height: 70vh;" class="col-3 p-2">
            ...
            <button id="page-four" class="btn btn-outline-primary btn-block mt-2  settingsButton active">Сменить три</button>
        </div>
        <div class="col-9 p-2">
